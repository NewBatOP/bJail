...
print("^4Createur: BatOP^0")
print("Merci de ne pas skid ma resource...")
print("Développer en 1 heure")
print("Oublier pas meilleur serveur RP : SynaLife")
...
function RageUI.Description()
    ...
    if CurrentMenu ~= nil and CurrentMenu.Description ~= nil then
        if CurrentMenu() then
            ...
            RenderSprite(Description.Background.Dictionary, Description.Background.Texture, CurrentMenu.X, CurrentMenu.Y + Description.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, Description.Background.Width + CurrentMenu.WidthOffset, CurrentMenu.DescriptionHeight, 255, 255, 255, 255)
